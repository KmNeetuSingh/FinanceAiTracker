    ...
    <div className="min-h-screen flex flex-col">
      <main className="flex-1 bg-gradient-to-b from-slate-900 via-slate-900 to-slate-800">
        <div className="max-w-7xl mx-auto px-6 py-12 md:py-16 grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="relative rounded-2xl overflow-hidden shadow-xl bg-black ring-1 ring-white/10">
            ...
            <div className="absolute bottom-0 left-0 p-6">
              ...
              <p className="text-white/80 text-sm md:text-base">Import statements, auto‑categorize, track spending in seconds.</p>
            </div>
          </div>

          <div className="text-white">
            <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-blue-500/10 text-blue-300 ring-1 ring-inset ring-blue-500/20">New • AI‑powered insights</span>
            ...
            <div className="mt-6 text-xs text-slate-400">Video auto‑plays muted per browser policy. Click to unmute if needed.</div>
