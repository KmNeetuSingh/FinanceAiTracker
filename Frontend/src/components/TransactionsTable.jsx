...
const TransactionsTable = ({
  ...
  if (transactions.length === 0) {
    return (
      <div className="card text-center py-12 bg-gray-800 rounded-lg">
  ...
  return (
    <div className="card text-white bg-gray-900 rounded-lg p-6 shadow-lg">
      {/* Header */}
        ...
        <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-4">
          <div className="relative">
            ...
            <input
              ...
              className="pl-10 pr-4 py-2 border border-gray-600 rounded-lg text-white placeholder-gray-400 bg-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-wrap gap-4 mb-6 items-center">
        ...
        <select
          ...
          className="px-3 py-2 border border-gray-600 rounded-lg text-sm bg-gray-800 text-white focus:ring-2 focus:ring-blue-500"
        >
              ...
              <tr key={transaction._id} className="hover:bg-gray-800">
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm">
                  <div className="flex space-x-2">
                    <button onClick={() => onEdit(transaction)} className="text-blue-400 hover:text-blue-600" title="Edit transaction">
                      <Edit3 className="h-4 w-4" />
                    </button>
                    <button onClick={() => onDelete(transaction._id)} className="text-red-400 hover:text-red-600" title="Delete transaction">
      ...
      {/* Pagination - Only Previous and Next */}
      {totalPages > 1 && (
