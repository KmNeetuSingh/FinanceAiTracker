    ...
    <div className="card text-white">
        ...
        <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-4">
          <div className="relative">
            ...
            <input
              ...
              className="pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-white
      ...
      <div className="flex flex-wrap gap-4 mb-6">
        ...
        <select
          ...
          className="px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2  bg-gray-700 text-white focus:ring-blue-500 focus:border-transparent "
        >
